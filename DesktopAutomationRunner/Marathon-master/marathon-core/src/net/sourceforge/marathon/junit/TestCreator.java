...
public class TestCreator {
    ...
    public Test getTest(List<String> testCases, Properties testData) //HNA
    {
      try
      {
        return new CosmicAutomatedDDTestSuite(getFile(testCases.get(0)), acceptChecklist, console, testData);
      }
      catch (IOException e)
      {
        e.printStackTrace();
